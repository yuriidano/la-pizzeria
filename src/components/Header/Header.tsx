...
export const Header = () => {
    ...
    return (
        <header className="!flex !items-center justify-between gap-x-5 min-h-[clamp(70px,45.704px+7.593vw,152px)] !border-b  !border-gray-200 ss-320:!py-3.5 ss-320:items-start">
            <div className='flex items-end gap-x-6  ss-320:flex-col ss-320:items-start ss-320:gap-2 ss-320:justify-end 
             sm:flex-row sm:items-center sm:gap-x-8 '>
                <div className='flex gap-x-3 items-center'>
                    <div className='min-w-7block hidden  md:min-w-10 ss-550:block'>
            ...
            <div className={classNames('min-h-[clamp(30px,17.593px+2.315vw,40px)] bg-my-orange flex gap-x-7 !px-[clamp(18px,15.037px+0.926vw,28px)] rounded-3xl ss-320:self-start sm:self-center ', stylles.button)}>
